...
void gPtp_Sync::copy(const gPtp_Sync& other)
{
    ...
    this->localDrift = other.localDrift;
...
void gPtp_Sync::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->localDrift);
...
void gPtp_Sync::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->localDrift);
...
omnetpp::SimTime& gPtp_Sync::getLocalDrift()
{
    return this->localDrift;
}

void gPtp_Sync::setLocalDrift(const omnetpp::SimTime& localDrift)
{
...
int gPtp_SyncDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='l' && strcmp(fieldName, "localDrift")==0) return base+1;
    if (fieldName[0]=='o' && strcmp(fieldName, "originTimestamp")==0) return base+2;
...
std::string gPtp_SyncDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: {std::stringstream out; out << pp->getLocalDrift(); return out.str();}
        case 2: {std::stringstream out; out << pp->getOriginTimestamp(); return out.str();}
        default: return "";
    }
}
...
void *gPtp_SyncDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return (void *)(&pp->getLocalDrift()); break;
        case 2: return (void *)(&pp->getOriginTimestamp()); break;
        default: return nullptr;
    }
}
...
omnetpp::SimTime& gPtp_FollowUp::getRateRatio()
{
    return this->rateRatio;
}

void gPtp_FollowUp::setRateRatio(const omnetpp::SimTime& rateRatio)
{
...
int gPtp_FollowUpDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='r' && strcmp(fieldName, "rateRatio")==0) return base+3;
    if (fieldName[0]=='n' && strcmp(fieldName, "numberOfHops")==0) return base+4;
    return basedesc ? basedesc->findField(fieldName) : -1;
}
...
std::string gPtp_FollowUpDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: {std::stringstream out; out << pp->getRateRatio(); return out.str();}
        case 4: return long2string(pp->getNumberOfHops());
        default: return "";
    }
}
...
bool gPtp_FollowUpDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    gPtp_FollowUp *pp = (gPtp_FollowUp *)object; (void)pp;
    switch (field) {
        case 4: pp->setNumberOfHops(string2long(value)); return true;
        default: return false;
    }
}
...
void *gPtp_FollowUpDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return (void *)(&pp->getRateRatio()); break;
        default: return nullptr;
    }
}
